                  ...
                  <div class="form-body mt-4">
                    <form class="row g-3" method="POST" action="{{ route('password.update') }}" >
                      ...
                      <div class="col-12">
                        ...
                        <input type="text"  class="form-control" id="NewPassword" placeholder="Enter new password" name="password" required autocomplete="new-password">
                      </div>
                      <div class="col-12">
                        <label class="form-label" for="ConfirmPassword">Confirm Password</label>
                        <input type="text"  class="form-control" id="ConfirmPassword" placeholder="Confirm password" name="password_confirmation" required autocomplete="new-password">
                      </div>
                      <div class="col-12">
                        <div class="d-grid gap-2">
                          <button type="submit" class="btn btn-grd-branding">Change Password</button>
                           <a href="{{ route('sign-in') }}" class="btn btn-grd-royal">Back to Login</a>
                        </div>
                      </div>
                    </form>
                  </div>
